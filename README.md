...
* 定型文 のホバー内で分岐に対応
* 定型文 に 話中　を追加
* 話中 から分岐　無音／保留音・機械音／自分の声が聞こえていない様子／相手の声が聞こえにくい（ノイズ・遠い）／話し中、突然相手の声が聞こえなくなった／クロージングしたのに電話が切れていない
...
* ヒアリングタブ
  ...
  * ログ作成補助 ボタンは縦1列で並べる
  * ［入力］を挿入 の位置
  * ヒアリング項目のAdd/Editエリア　新しいテンプレートを作る を選択した時の「新しい名前（ラベル）」「入力欄」を テンプレート名プルダウンの右側に表示
  * 回答方法を先に決めてから項目名をきめるため、Add/Editエリア内の並びを変更
